...
import com.design.composeNur.utils.dragContainer
import com.design.composeNur.utils.draggableItems
import com.design.composeNur.utils.rememberDragDropState
...
import com.design.composeNur.utils.NurShadowParams
...
fun GroupingContainerScreen() {
    ...
    Box {
        LazyColumn(
            modifier = Modifier
                .softLayerShadow(params = NurShadowParams.Default.copy(spread = 2.dp))
