 ...
 * @see NurDescriptionBottomSheetParams
 */
...
fun NurDescriptionBottomSheet(
    ...
    buttonText: String,
    params: NurDescriptionBottomSheetParams = NurDescriptionBottomSheetParams.Default,
    onButtonClick: () -> Unit,
...
private fun NurDescriptionBottomSheetContentPreview() {
    ChiliTheme {
        NurDescriptionBottomSheetContent(
            ...
            buttonText = "OK",
            onButtonClick = {},
            params = NurDescriptionBottomSheetParams.Default
        )
    }
}
