...
fun MaterialDesignSlider(
    ...
    colors: SliderColorsM2 = SliderDefaultsM2.colors()
) {
...
object SliderDefaultsM2 {
    ...
    ): SliderColorsM2 = DefaultSliderColors(
...
private fun RangeSliderImpl(
    ...
    val startContentDescription = 5
    val endContentDescription = 6
    ...
    Box(modifier.then(DefaultSliderConstraints)) {
        ...
        SliderThumb(
            Modifier
                .semantics(mergeDescendants = true) {
                    contentDescription = startContentDescription.toString()
                }
        ...
        SliderThumb(
            Modifier
                .semantics(mergeDescendants = true) {
                    contentDescription = endContentDescription.toString()
                }
        ...
        Tick(
            ...
            enabled = enabled,
            tickFractions = tickFractions,
            positionFractionStart = positionFractionStart,
            positionFractionEnd = positionFractionEnd,
            thumbPx = thumbPx,
            trackStrokeWidth = trackStrokeWidth
        )
    }
...
private val ThumbRippleRadius = 12.dp
private val ThumbDefaultElevation = 1.dp
private val ThumbPressedElevation = 6.dp

// Internal to be referred to in tests
internal val TrackHeight = 2.dp
