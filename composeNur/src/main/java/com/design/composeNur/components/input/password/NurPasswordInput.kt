 ...
 * @param [value] The current text value of the [NurPasswordInput]. This should be a [String]
 ...
 * @param [isEnabled] A flag to enable or disable the [NurPasswordInput] field.
 ...
 * @param [params] A set of customizable parameters (e.g., text style, colors, padding) for the [NurPasswordInput]
 * Default is [PasswordInputParams.Default]
 *
 */

@Composable
fun NurPasswordInput(
    ...
    onImeAction: () -> Unit = {},
    passwordVisibleEndIcon: Painter = painterResource(id = R.drawable.nur_ic_visible),
    passwordInvisibleEndIcon: Painter = painterResource(id = R.drawable.nur_ic_invisible),
...
fun PasswordInputPreview() {
    NurTheme {
        NurPasswordInput(value = "Password")
    }
}
